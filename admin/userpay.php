    ...
    <div id="content">
        <div id="content-header">
            <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i>
                    Home</a> <a href="payment.php" class="tip-bottom">Payment</a> <a href="#" class="current">Make
                    Payments</a> </div>
            <h1>Payments</h1>
        </div>
        <form role="form" action="index.php" method="POST">
            ...
            if (isset($_POST['user_id'])) {
                ...
                $amount = $invoice_row['amount'] / $invoice_row['duration_months'];
                                    ...
                                    <div class="content">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="content-block text-center">
                                                                        We sincerely appreciate your promptness regarding all
                                        ...
                                        <div class="footer">
                                            <table width="100%">
                                                <tbody>
                                                    <tr>
                                                        <td class="aligncenter content-block"><button class="btn btn-danger"
