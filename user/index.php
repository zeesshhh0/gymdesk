...
<body>
    ...
    <div id="loginbox">
        ...
        <form id="recoverform" action="../user/pages/register-cust.php" method="POST" class="form-vertical">
            ...
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_lo"><i class="icon-asterisk"></i></span><input type="password"
            ...
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_lo"><i class="icon-leaf"></i></span><input type="number" name="contact"
